...
version: 
Author: LiQiang
Date: 2021-05-06 13:40:28
LastEditTime: 2021-05-06 16:09:42
'''
import copy
...
def _get_clones(module,N):
    ...
    N:复制多少个
    """
    return nn.ModuleList([copy.deepcopy(module) for i in N])
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(self,src,
        ...
        """
        q=k=self.with_pos_embed(src,pos)  # 输入向量加上位置编码
